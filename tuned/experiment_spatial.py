"""Experiment 2: Enhanced Spatial Representation Screening (5-fold Wafer-Grouped CV).

Compares Model A Baseline vs Model A + Enhanced Spatial Features.
"""
...
def evaluate_5fold(
    ...
    # Wafer-level target for stratified splitting
    ...
    # Overall OOF evaluation on passing dies
    ...
    # Optimal F1 threshold grid search on OOF predictions
    ...
    # Calculate fold F1s using best threshold
    for fold, (train_w_idx, val_w_idx) in enumerate(
        sgkf.split(wafer_ids, wafer_labels, groups=wafer_ids)
    ):
        val_wafers = set(wafer_ids[val_w_idx])
...
def main():
    parser = argparse.ArgumentParser(description="Experiment 2: Enhanced Spatial Features Screening")
    ...
    experiments = [
        (
            "model_a_baseline",
            {"use_block": False, "use_parametric": True, "use_parametric_mlp": False, "use_enhanced_spatial": False},
        ),
        (
            "model_a_enhanced_spatial",
            {"use_block": False, "use_parametric": True, "use_parametric_mlp": False, "use_enhanced_spatial": True},
        ),
        (
            "spatial_only_baseline",
            {"use_block": False, "use_parametric": False, "use_parametric_mlp": False, "use_enhanced_spatial": False},
        ),
        (
            "spatial_only_enhanced",
            {"use_block": False, "use_parametric": False, "use_parametric_mlp": False, "use_enhanced_spatial": True},
        ),
    ]

    results = []
    print("\nRunning Spatial Feature Evaluation (5 folds)...")
    ...
    print("\nFinal Spatial Experiment Summary:")
